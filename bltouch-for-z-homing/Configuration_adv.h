...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.22 //.0   // Unit: mm compression per 1mm/s extruder speed
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_12V  //  CHOPPER_DEFAULT_24V    // All axes (override below)
